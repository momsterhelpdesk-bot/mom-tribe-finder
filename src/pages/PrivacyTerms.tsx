          ...
          <section className="prose prose-sm max-w-none space-y-8">
            ...
            <div>
              ...
              <p className="mb-4 font-medium bg-primary/10 p-4 rounded-lg">
                📱 Ο χρήστης μπορεί οποιαδήποτε στιγμή να ζητήσει τη διαγραφή του λογαριασμού του μέσα από την εφαρμογή 
                (Προφίλ → Διαγραφή λογαριασμού). Με τη διαγραφή, όλα τα προσωπικά δεδομένα αφαιρούνται οριστικά σύμφωνα 
                με την Πολιτική Απορρήτου.
              </p>
              <p className="mb-2">Με τη διαγραφή:</p>
              <ul className="list-disc pl-6 mb-4 space-y-1">
                <li>Το προφίλ και όλο το περιεχόμενο του χρήστη διαγράφονται οριστικά</li>
                <li>Τα μηνύματα και τα matches αφαιρούνται</li>
                <li>Δεν είναι δυνατή η ανάκτηση του λογαριασμού μετά τη διαγραφή</li>
