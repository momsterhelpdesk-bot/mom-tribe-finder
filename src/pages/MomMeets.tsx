      ...
      <div className="max-w-2xl mx-auto pt-6 px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            ...
            Οργανώνονται από τις ίδιες τις μαμάδες.<br /><br />
            Πας παιδική χαρά, βόλτα ή για καφέ με τα παιδιά και θέλεις παρέα;<br />
            Δημιουργείς ένα Mom Meet και βρίσκεις άλλες μαμάδες να έρθουν μαζί σου. 🌸
          </p>
